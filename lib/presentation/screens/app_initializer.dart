...
import 'package:cogni_anchor/services/camera_store.dart';
...
class _AppInitializerState extends State<AppInitializer> {
  ...
  void initState() {
    super.initState();
    _initializeApp(); // 🔴 DO NOT delay this
  }

  Future<void> _initializeApp() async {
    try {
      // 1️⃣ Supabase (must be first)
      ...
      // 2️⃣ Notifications (CRITICAL: before UI)

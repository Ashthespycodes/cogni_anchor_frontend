          ...
          children: [
            ...
            Center(
              child: Row(
                ...
                children: [
                  ToggleButton(label: "Audio", selected: isAudio, onTap: () => setState(() => isAudio = true)),
                  Gap(12.w),
                  ToggleButton(label: "Text", selected: !isAudio, onTap: () => setState(() => isAudio = false)),
                ],
              ),
            ),
            ...
            Row(
              children: [
                ...
                Gap(10.w),
                Expanded(child: AppText("I suggest you some frequently performed tasks.", fontSize: 15.sp)),
              ],
            ),
            ...
            Wrap(
              spacing: 10.w,
              runSpacing: 12.h,
              children: const [QuickChip("Set a reminder"), QuickChip("Turn on live location"), QuickChip("Turn on microphone share"), QuickChip("Recognize this person")],
            ),
  ...
  PreferredSizeWidget _buildAppbar() {
    return PreferredSize(
      ...
      child: AppBar(
        ...
        title: AppText("Chatbot AI", fontSize: 20.sp, color: Colors.white, fontWeight: FontWeight.w600),
      ),
    );
  }
}

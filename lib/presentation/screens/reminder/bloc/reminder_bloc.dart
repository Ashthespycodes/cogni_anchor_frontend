...
import 'package:cogni_anchor/services/reminder_supabase_service.dart';
import 'package:cogni_anchor/services/notification_service.dart';
...
class ReminderBloc extends Bloc<ReminderEvent, ReminderState> {
  ...
  /// 📥 LOAD + AUTO DELETE EXPIRED REMINDERS
  Future<void> _onLoadReminders(
    ...
    try {
      ...
      // 🔴 DELETE EXPIRED REMINDERS FROM DB
  ...
  Future<void> _onAddReminder(
    ...
    try {
      ...
      // 🔴 Reload reminders (UI will pop automatically)
      add(LoadReminders());
    } catch (e, st) {

        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              ReminderMainCardWidget(title: "Drink Water", time: "11:00 AM Today", color: colors.appColor),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ReminderChildCardWidget(title: reminders[index].title, date: reminders[index].date, time: reminders[index].time, color: colors.appColor);
                  },
                ),
              ),
            ],
